...
export class ColorUtils {
     ...
     * @param color
     */
    public static hsv2rgb(color: IColorHSV): IColorRGB {
        let red = 0;
        let green = 0;
        let blue = 0;
     ...
     * @param color
     */
    public static rgb2hsv(color: IColorRGB): IColorHSV {
     ...
     * @param color
     */
    public static hsv2hex(color: IColorHSV): string {
     ...
     * @param hex
     */
    public static hex2rgb(hex: string): IColorRGB {
        if (hex.length === 3) {
            hex = hex.replace(/./g, "$&$&");
        }
        return {
     ...
     * @param hex
     */
    public static hex2hsv(hex: string): IColorHSV {
     ...
     * @param color
     */
    public static rgb2hex(color: IColorRGB): string {
